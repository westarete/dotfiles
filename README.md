...
* `.vimrc.local` Is where you put your own personal configs if you desire. If you find a config you just can't live without, maybe we'll add it to the main .vimrc file.
